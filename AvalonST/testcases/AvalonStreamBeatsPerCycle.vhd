...
begin
  ...
  receiver_proc : process
      variable GetData : slv_array_t(0 to 11)(31 downto 0) := (
    "00000000000000000000000000000001", -- 1
    "00000000000000000000000000000010", -- 2
    "00000000000000000000000000000011", -- 3
    "00000000000000000000000000000100", -- 4
  ...
  begin
    wait until Reset = '1';
    wait for 0 ns;
    SetAvalonStreamOptions(StreamRxRec, BEATS_PER_CYCLE, 4);
    wait for 10 ns;
   
    Receive(StreamRxRec, 12);
    wait for 50 ns;
    Get(StreamRxRec, GetData, 12);
    for i in 0 to 11 loop
      AffirmIf(GetData(i) = ExpData(i), "Data match");
    end loop;
     wait for 100 ns;
    WaitForBarrier(TestDone);
    wait;
